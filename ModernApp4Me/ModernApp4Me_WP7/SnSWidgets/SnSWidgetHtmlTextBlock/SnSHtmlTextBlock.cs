...
namespace ModernApp4Me_WP7.SnSWidgets.SnSWidgetHtmlTextblock
{
    [TemplatePart(Name = PartItemsControl, Type = typeof(ItemsControl))]
    public class SnSHtmlTextBlock : Control
    {
        private ItemsControl _internalItemsControl;
        private const string PartItemsControl = "PART_ItemsControl";

        static SnSHtmlTextBlock()
        {
            HtmlProperty = DependencyProperty.Register("Html", typeof(string), typeof(SnSHtmlTextBlock), new PropertyMetadata(HtmlChanged));
            NavigationCommandProperty = DependencyProperty.Register("NavigationCommand", typeof(ICommand), typeof(SnSHtmlTextBlock), new PropertyMetadata(NavigationCommandChanged));

            HyperlinkFontFamilyProperty = DependencyProperty.Register("HyperlinkFontFamily", typeof(FontFamily), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            HyperlinkFontSizeProperty = DependencyProperty.Register("HyperlinkFontSize", typeof(double?), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            HyperlinkFontStretchProperty = DependencyProperty.Register("HyperlinkFontStretch", typeof(FontStretch), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            HyperlinkFontStyleProperty = DependencyProperty.Register("HyperlinkFontStyle", typeof(FontStyle), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            HyperlinkFontWeightProperty = DependencyProperty.Register("HyperlinkFontWeight", typeof(FontWeight), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            HyperlinkForegroundProperty = DependencyProperty.Register("HyperlinkForeground", typeof(Brush), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));

            H1FontFamilyProperty = DependencyProperty.Register("H1FontFamily", typeof(FontFamily), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H1FontSizeProperty = DependencyProperty.Register("H1FontSize", typeof(double?), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H1FontStretchProperty = DependencyProperty.Register("H1FontStretch", typeof(FontStretch), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H1FontStyleProperty = DependencyProperty.Register("H1FontStyle", typeof(FontStyle), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H1FontWeightProperty = DependencyProperty.Register("H1FontWeight", typeof(FontWeight), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H1ForegroundProperty = DependencyProperty.Register("H1Foreground", typeof(Brush), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));

            H2FontFamilyProperty = DependencyProperty.Register("H2FontFamily", typeof(FontFamily), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H2FontSizeProperty = DependencyProperty.Register("H2FontSize", typeof(double?), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H2FontStretchProperty = DependencyProperty.Register("H2FontStretch", typeof(FontStretch), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H2FontStyleProperty = DependencyProperty.Register("H2FontStyle", typeof(FontStyle), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H2FontWeightProperty = DependencyProperty.Register("H2FontWeight", typeof(FontWeight), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H2ForegroundProperty = DependencyProperty.Register("H2Foreground", typeof(Brush), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));

            H3FontFamilyProperty = DependencyProperty.Register("H3FontFamily", typeof(FontFamily), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H3FontSizeProperty = DependencyProperty.Register("H3FontSize", typeof(double?), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H3FontStretchProperty = DependencyProperty.Register("H3FontStretch", typeof(FontStretch), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H3FontStyleProperty = DependencyProperty.Register("H3FontStyle", typeof(FontStyle), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H3FontWeightProperty = DependencyProperty.Register("H3FontWeight", typeof(FontWeight), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
            H3ForegroundProperty = DependencyProperty.Register("H3Foreground", typeof(Brush), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));

            BlockQuoteBackgroundProperty = DependencyProperty.Register("BlockQuoteBackground", typeof(Brush), typeof(SnSHtmlTextBlock), new PropertyMetadata(null));
        }

        public SnSHtmlTextBlock()
        {
            DefaultStyleKey = typeof(SnSHtmlTextBlock);
            _navigationHandler = OnNavigationRequested;
        }
        ...
        {
            var instance = (SnSHtmlTextBlock)o;
        ...
        private readonly RoutedEventHandler _navigationHandler;
        ...
        public override void OnApplyTemplate()
        {
            ...
            _internalItemsControl = (ItemsControl)GetTemplateChild(PartItemsControl);
...
// ReSharper restore RedundantStringFormatCall
        ...
        private void AppendImage(HtmlNode node, Paragraph paragraph)
        {
            ...
            {
                var bitmap = new BitmapImage(new Uri(node.Attributes["src"].Value))
                    {
                ...
                bitmap.ImageOpened += delegate
                {
                    ...
                    double actualWidth = _currentRtb.ActualWidth;
                    image.Source = bitmap;
        ...
        private void AppendRun(HtmlNode node, Paragraph paragraph, Span span)
        {
            ...
            {
                if (!SnSHtmlTextBlockDesignerHelper.IsInDesignModeStatic)
                {
